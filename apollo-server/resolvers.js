...
export default {
  ...
  Query: {
    ...
    modules: (root, args, { db }) => db.get('moduleIndex').value(),
    moduleItems: (root, args, { db }) => db.get('moduleItems').value(),
    moduleCreatings: (root, args, { db }) => db.get('moduleCreatings').value(),
    moduleProgressMes: (root, args, { db }) =>
      db.get('moduleProgressMes').value()
  },
